...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls > 0:
        ...
        num_rolls -= 1
    #print (roll_results) #to check if list is saving correctly
    def pig_out(results):
        if 1 in results:
            return 1
        return sum(results)
    return pig_out(roll_results)
    # END PROBLEM 1
...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    score_str = str(score)
    return int(max(list(score_str))) + 1
    # END PROBLEM 2
...
def is_swap(score0, score1):
    ...
    for i in range(2, 200):
        if (score0 / score1 == i) or (score1 / score0 == i):
            return True
    return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    announcement = say(score0, score1)
    if score0 < goal and score1 < goal:
        score1 = score1 + take_turn(strategy1(score1, score0), score0, dice)
        if is_swap(score0, score1):
            score0, score1 = score1, score0
        say = announcement(score0, score1)
    if score0 < goal and score1 < goal:  #implement for full game
...
def both(f, g):
    ...
    """
    # BEGIN PROBLEM 6
    def both_level_2(score0,score1):
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def announcer(score0, score1):
        ...
        if change > previous_high and change == 1:
            print("1 point! That's the biggest gain yet for Player", str(who))
        if change > previous_high and change >= 2 and who == 1:
            print(str(score1 - previous_score), "points! That's the biggest gain yet for Player", str(who))
        if change > previous_high and change >= 2 and who == 0:
            print(str(score0 - previous_score), "points! That's the biggest gain yet for Player", str(who))
        if change > previous_high:
            new_previous_high = change
        if change <= previous_high:
...
def make_averaged(fn, num_samples=1000):
    ...
    dividend = num_samples
    def average_func(*args):
        results = []
        for i in range (0, num_samples):
            results.append(fn(*args))
        return sum(results)/dividend
    return average_func
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    averages = []
    for i in range(1,11):
        averages.append(make_averaged(roll_dice, num_samples)(i, dice))
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if is_swap((score + free_bacon(opponent_score)), opponent_score) == True and (opponent_score - score + free_bacon(opponent_score)) >= margin:
        return 0
    if free_bacon(opponent_score) >= margin:
        return 0
    else:
