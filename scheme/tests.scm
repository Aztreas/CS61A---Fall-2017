...
(begin (begin 1) (begin 2 3) (begin 1 2 3 4))
; expect 4

(begin (print 8) (print 8))
; expect 8

(begin nil)
; expect ()

(begin (define a 5) (define b (+ a 5)) (define c (* b 3)) c)
; expect 30

(define z (lambda (x) (+ x x x x)))
; expect z

(z 20)
; expect 80

(define d (lambda (x) (+ (* x 3) (z x))))
; expect d
